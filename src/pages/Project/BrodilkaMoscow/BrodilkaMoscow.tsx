...
export const BrodilkaMoscow = () => {
  ...
  return (
    <section className={s.moscow}>
      <Mainscreen path="projects/brodilkamoscow/mainscreen.jpeg" />
      <div className="container">
        ...
        <div className={s.buttons}>
          ...
          <div className={s.ar}>
            {t("project.list.brodilkamoscow.buttons.2")}
          </div>
        </div>
        <img
          className={s.moscow_image_1}
          src={require("assets/projects/brodilkamoscow/image1.jpeg")}
          alt="Brodilka Moscow"
        />
        ...
        <img
          ...
          src={require("assets/projects/brodilkamoscow/image2.jpeg")}
          alt="Brodilka Moscow"
        />
        ...
        <img
          ...
          src={require("assets/projects/brodilkamoscow/image3.jpeg")}
          alt="Brodilka Moscow"
        />
        <img
          className={s.moscow_image_4}
          src={require("assets/projects/brodilkamoscow/image4.jpeg")}
          alt="Brodilka Moscow"
        />
      </div>
    </section>
