  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Благотворительный мерч NEW CITY ARTISTS X PUBLICART"
        />
      </Helmet>
        ...
        <section className={s.collab}>
          <ul className={s.breadcrumb}>
            <CustomLink className="link" to="/">
              <li className={s.pushkeen}>
                {t("merch.collab.breadcrumb.main")}
              </li>
            </CustomLink>
            &nbsp;&nbsp;/&nbsp;&nbsp;
          ...
          <div className={s.main}>
            ...
            <div className={s.main_wrapper}>
              <div className={s.main_text}>
                ...
                <span className={s.cotton}>
                  {t("merch.collab.main.cotton")}
                </span>
              </div>
          ...
          <div className={s.grid}>
            <div className={s.item_1}>
              <img src={require("assets/merch/item_1.jpeg")} alt="Photo" />
            </div>
            <div className={s.item_2}>
              <img src={require("assets/merch/item_2.jpeg")} alt="Photo" />
            </div>
            <div className={s.item_3}>
              <img src={require("assets/merch/item_3.jpeg")} alt="Photo" />
            </div>
            <div className={s.item_4}>
              <img src={require("assets/merch/item_4.jpeg")} alt="Photo" />
            </div>
            ...
            <div className={s.item_7}>
              <img src={require("assets/merch/item_7.jpeg")} alt="Photo" />
            </div>
          </div>
        </section>
        <ArrowUp />
