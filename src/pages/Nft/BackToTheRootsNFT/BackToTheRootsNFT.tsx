...
export const BackToTheRootsNFT = () => {
  ...
  return (
    <>
      <Helmet>
        <title>PushKeen - BACK TO THE ROOTS</title>
        <meta
          name="description"
          content="На протяжении шести дней художники создавали арт-объекты, которые мы затем перенесли в NFT-пространство. В результате этого перформанса появилась самая высокогорная галерея легального стрит-арта."
        />
      </Helmet>
        ...
        <div className="container">
          ...
          <div className={s.video_wrapper}>
            ...
            <div className={s.img_label}>
              <span>
                {t("project.list.nft_list.btrNft.image_labels.token1")}
              </span>
              <div className={s.circle}></div>
            </div>
          </div>
          <div className={s.video_wrapper}>
            ...
            <div className={s.img_label}>
              <span>
                {t("project.list.nft_list.btrNft.image_labels.token2")}
              </span>
              <div className={s.circle}></div>
            </div>
          </div>
